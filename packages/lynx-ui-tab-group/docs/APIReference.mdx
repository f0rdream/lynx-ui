...
<UIApiTable source={[
  ...
  },
  {
    ...
    "type": "{damping?: number, mass?: number, stiffness?: number, type?: [object Object], velocity?: number, duration?: number, ease?: (t: number) => number}",
    "summary": [
      {
        "kind": "text",
  ...
  },
  {
    ...
    "summary": [
      {
        "kind": "text",
        "text": "Scroll to the clicked tab smoothly."
      }
    ],
    "summary_zh": [
      {
...
<UIApiTable source={[
  ...
  {
    "name": "renderTabItem",
    "type": "(tabItem: {getTabKey: () => string, tabItem: T}) => ReactNode",
    "summary": [
      {
        "kind": "text",
